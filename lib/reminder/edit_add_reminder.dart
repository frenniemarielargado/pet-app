...
import 'package:thesis_app/reminder/edit_others_reminder.dart';
...
class _EditReminderState extends State<EditReminder> {
  String _selectedItem  = 'Vaccination';
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    onChanged: (String? newValue) {
                      ...
                      if (_selectedItem == 'Others') {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const EditOthersReminder()),
                        );
                      }
                    },
                  ),
