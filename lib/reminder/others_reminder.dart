...
class OthersReminder extends StatefulWidget {
  const OthersReminder({super.key});

  @override
  State<OthersReminder> createState() => _OthersReminderState();
}

class _OthersReminderState extends State<OthersReminder> {
